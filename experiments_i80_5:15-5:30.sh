...
DATA_NAME="I80_5:15_5:30pm_075_seed${SEED}.pth"
STUDY_SUFFIX="scaled_data_seed${SEED}_I80_5:15_5:30pm"
...
python main.py \
  ...
  --data_name=${DATA_NAME} \
  --load_data \
  --vel_path=./data/I80/NGSIM_US80_5:15_5:30_pm_Velocity_Data.txt \
  --dens_path=./data/I80/NGSIM_US80_5:15_5:30_pm_Density_Data.txt
